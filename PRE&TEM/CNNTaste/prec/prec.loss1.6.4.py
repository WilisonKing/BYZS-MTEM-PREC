...
for epoch in range(EPOCH): 
    ...
    for step,(x,y,aver_l) in enumerate(train_loader): 
        ...
        outlast=Variable(output-aver_l,requires_grad=True).cuda()
        labellast=Variable(b_y-aver_l).cuda()
        optimizer.zero_grad() 
    ...
    if epoch>-1:
        ...
        for k,(m,n,aver_l2) in enumerate(test_loader): 
            ...
            outlast2=Variable(output2-aver_l2,requires_grad=True).cuda()
            labellast2=Variable(t_y-aver_l2).cuda()
